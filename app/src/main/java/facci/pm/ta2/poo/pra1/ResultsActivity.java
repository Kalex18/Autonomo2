...
public class ResultsActivity extends AppCompatActivity implements  ListView.OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position,
        ...
        Intent intent = new Intent(ResultsActivity.this,DetailActivity.class);//el objeto inten se utiliza para poder llevar de un activii a otro
        intent.putExtra("object_id",object.m_objectId); //se envia los parametros que quemos mostrar por medio de intent
        startActivity(intent); // se traslada o inicia el nuevo activity

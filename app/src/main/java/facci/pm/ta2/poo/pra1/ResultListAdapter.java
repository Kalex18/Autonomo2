   ...
   public ArrayList<DataObject> m_array;
    ...
    public View getView(int position,  View view, ViewGroup parent) {
        ...
        // INICIO - CODE4
            ...
            TextView price = (TextView)vp.findViewById(R.id.price); //se obtiene el control del eleemento price
        title.setText((String) object.get("price")); //se envia el texto conteniedo dentro del eleementto price
